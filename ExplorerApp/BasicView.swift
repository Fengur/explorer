...
class BasicView:CustomView {
    ...
    func createHSlider(){
        ...
        let hSlider:Slider = hSliderCard.addSubView(Slider(120,6,.hor,CGSize(70,6),0,hSliderCard))
        _ = hSlider
    }
    /**
     * Checkbox
    ...
    func createList(){
        ...
        let list:List3 = listCard.addSubView(List3(140, 73, CGSize(NaN,NaN), dp,.ver, listCard))
        list.selectAt(1)
    }
